#!/usr/bin/env python3
"""
Script to create PowerPoint slides from presentation.md content
"""
...
subtitle.text = "Real-time Performance Monitoring with No-Fallback Feature"
...
bullet_points = [
    ...
    "Production environments require accurate metrics (no sample data)"
]
...
solution_points = [
    ...
    "New no-fallback feature for production environments"
]
...
# Slide 5: No-Fallback Feature
slide_layout = prs.slide_layouts[1]  # Title and Content layout
slide = prs.slides.add_slide(slide_layout)
slide.shapes.title.text = "No-Fallback Feature"

# Content
content = slide.placeholders[1].text_frame
p = content.paragraphs[0]
p.text = "Problem Solved:"
p.font.bold = True
p.font.size = Pt(24)
p.font.color.rgb = ACCENT_COLOR

problem_points = [
    "Production environments need strict data quality",
    "Sample data could lead to incorrect operational decisions",
    "Need clear visibility when metrics collection fails"
]
...
implementation_points = [
    "Added `--no-fallback` command-line flag",
    "Updated run_demo.sh and run_realtime_dashboard.sh",
...
# Add code block
code_textbox = slide.shapes.add_textbox(Inches(0.8), Inches(1.8), Inches(11.5), Inches(1.5))
code_tf = code_textbox.text_frame
code_p = code_tf.paragraphs[0]
code_p.text = "# Standard mode with fallback"
...
code_p = code_tf.add_paragraph()
code_p.text = "\n# Production mode without fallback"
code_p.font.name = "Courier New"
code_p.font.size = Pt(18)

code_p = code_tf.add_paragraph()
code_p.text = "./run_demo.sh --no-fallback"
code_p.font.name = "Courier New"
code_p.font.size = Pt(18)

# Add key features section
features_textbox = slide.shapes.add_textbox(Inches(0.8), Inches(3.8), Inches(11.5), Inches(2))
...
features_points = [
    ...
    "Different behavior with/without fallback",
...
benefits_points = [
    ...
    "Production-ready with no-fallback option",
    "Clear visibility into metrics availability"
]
...
takeaways = [
    ...
    "New no-fallback feature enhances production reliability",
